...
import type { PeriodicReportPreviewResponse, ReportFormat } from "@/types";
...
export function PartnerPeriodicSection() {
  ...
  const onExportPeriodic = async () => {
    ...
    try {
      ...
      downloadBlob(blob, filename ?? `partner_periodic_file_${anio}_${mes}.${ext}`);
